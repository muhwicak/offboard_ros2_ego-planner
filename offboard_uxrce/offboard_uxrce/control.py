...
def main():
    ...
    cmd_ctrl = False
    cmd_pub = node.create_publisher(std_msgs.msg.Bool, '/cmd_message', qos_profile)
    ...
    try:
        ...
        while True:
            ...
            if key == 'm':
                cmd_ctrl = not cmd_ctrl
                cmd_msg = std_msgs.msg.Bool()
                cmd_msg.data = cmd_ctrl
                cmd_pub.publish(cmd_msg)
                print(f"CMD Control is now: {cmd_ctrl}")
